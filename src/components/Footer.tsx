...
const Footer = () => {
  return (
    <footer className="bg-white py-16 px-6 md:px-10 border-t border-border">
      <div className="container max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Arbitrage Bot</a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Trading Dashboard</a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Market Scanner</a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Custom Solutions</a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="flex-grow px-4 py-2 rounded-l-lg border border-r-0 border-gray-300 focus:outline-none focus:ring-1 focus:ring-primary/50 focus:border-primary"
              />
